        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="mt-4">
                    ...
                    <ul class="footer-social list-inline mt-4">
                        ...
                        <li class="list-inline-item">
                            <a href="https://www.facebook.com/ramoncastroreis/" class="social-icon" style="padding-top: 10px;">
            ...
            <div class="col-md-4 col-sm-4">
                ...
                <ul class="footer-menu list-unstyled mb-0 mt-4">
                    ...
                    <li><a href="#psico">Psicoterapias</a></li>

                    <li><a href="#farmaco">Farmacoterapia</a></li>
